 ...
 * @author Muaz
 */
public class Ahmadmuas extends Application implements Runnable {
    ...
    private void update() {
        ...
        if(inputKeyboard.contains("R")){//merotasi kotak se arah gerakan jarum jam saat key R di tekan
            sudutRotasi++;
        }
    }
    ...
    private void draw() {
        try {
            if (canvas != null) {
                ...
                //CONTOH MENGGAMBAR KOTAKYANG DAPAT DITRANSLASI DAN DIROTASI
                gc.save();
                gc.translate(cx, cy);
